...
export class DocumentationGenerator {
  ...
  constructor() {
    ...
    this.specParser = new SpecParser({} as any, this.logger);
   ...
   */
  private async extractOperations(parsedSpec: any): Promise<OperationData[]> {
    const operations: OperationData[] = [];
   ...
   */
  private async extractSchemas(parsedSpec: any): Promise<SchemaData[]> {
    const schemas: SchemaData[] = [];
   ...
   */
  private async extractOperationsFromCode(parsedCode: any): Promise<OperationData[]> {
    const operations: OperationData[] = [];
   ...
   */
  private async extractSchemasFromCode(parsedCode: any): Promise<SchemaData[]> {
    const schemas: SchemaData[] = [];
  ...
  private async prepareTemplateData(
    ...
    return {
      ...
      config,
      metadata,
      helpers: {} as any // Will be provided by template manager
    };
  }
   ...
   */
  private createDocumentationError(code: string, message: string, cause?: any): DocumentationError {
