 ...
 */
export type PluginState = 'unloaded' | 'loading' | 'loaded' | 'initializing' | 'initialized' | 'starting' | 'started' | 'stopping' | 'stopped' | 'error' | 'disabled';
/**
 ...
 */
export type HookType = 'validation.before' | 'validation.after' | 'validation.error' | 'parsing.before' | 'parsing.after' | 'parsing.error' | 'report.before' | 'report.after' | 'server.start' | 'server.stop' | 'config.change' | 'custom';
/**
